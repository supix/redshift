...
import { CalendarServiceFake } from './calendar.service.fake';

describe('CalendarServiceFake', () => {
  let service: CalendarServiceFake;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(CalendarServiceFake);
  });
